...
const translations: Record<Locale, Record<TranslationKey, string>> = {
  en: {
    ...
    "comparison.better": "better than official",
    "comparison.same": "same as official",
    "comparison.unranked": "not in your ranking",
    "comparison.worse": "worse than official",
  ...
  ru: {
    ...
    "comparison.better": "выше официального",
    "comparison.same": "как официально",
    "comparison.unranked": "нет в твоем рейтинге",
    "comparison.worse": "ниже официального",
